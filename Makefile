...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake USE_UPNP=- USE_QRCODE=1 -o Makefile camorracoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DQT_DISABLE_DEPRECATED_BEFORE=0 -DUSE_QRCODE -DUSE_DBUS -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_DBUS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lqrencode /home/syn/coins/camnew/src/leveldb/libleveldb.a /home/syn/coins/camnew/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5DBus -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
/home/syn/coins/camnew/src/leveldb/libleveldb.a: FORCE
	cd /home/syn/coins/camnew/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/syn/coins/camnew/build/build.h: FORCE
	cd /home/syn/coins/camnew; /bin/sh share/genbuild.sh /home/syn/coins/camnew/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		src/qt/res/icons/camorracoin-80.png \
		src/qt/res/icons/camorracoin-16.png \
